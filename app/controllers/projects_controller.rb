...
class ProjectsController < ::ApplicationController
  ...
  def project_params
    params.require(:project).permit(:name, :slug, :sources_location, :sources_kind, :sources_subdir, :sources_branch, :secrets, :description, :upstream_url, :logo, :_remove_logo)
  end
end
